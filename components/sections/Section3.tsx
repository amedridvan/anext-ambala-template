    ...
    return <div className="">
       <div className="">
           ...
           <div style={{ letterSpacing: 15 }} className="flex flex-row m-[10px] p-[10px] justify-center text-center ">
               <span className="text-2xl  mr-[10px] bold font-sans font-black">03</span>
           ...
           <p className="h-[50px] font-sans text-gray-600  ">The most important news of your projects</p>
      </div>
        <div className="relative  text-black pl-52  flex-row flex  ">
            <div className="w-[30%] flex flex-col justify-center items-center ">
                <p className="text-pink-600 font-sans text-xl w-full pb-4">
