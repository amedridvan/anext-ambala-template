...
<SwiperSlide><div>
    <span className="text-4xl block font-sass text-fuchsia-700 uppercase mb-[5px]">anext</span>
    <span className="uppercase text-2xl font-sass font-bold mb-[5px]" >next ambalaj</span>
